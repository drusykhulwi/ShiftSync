...
-- CreateEnum
CREATE TYPE "NOTIFICATION_TYPES" AS ENUM ('SHIFT_ASSIGNED', 'SHIFT_CHANGED', 'SHIFT_CANCELLED', 'SHIFT_PUBLISHED', 'SWAP_REQUESTED', 'SWAP_ACCEPTED', 'SWAP_DECLINED', 'SWAP_APPROVED', 'SWAP_REJECTED', 'DROP_REQUESTED', 'DROP_ACCEPTED', 'OVERTIME_WARNING', 'CONSECUTIVE_DAY_WARNING', 'SCHEDULE_PUBLISHED', 'AVAILABILITY_CHANGED', 'CERTIFICATION_EXPIRING', 'LOCATION_TRANSFER');
